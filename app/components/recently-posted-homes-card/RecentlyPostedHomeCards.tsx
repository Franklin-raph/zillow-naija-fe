...
export default function RecentlyPostedHomeCards({ listing }: { listing: HousePost }) {
  ...
  return (
    <div className='mb-5 shadow-md rounded-[20px] relative cursor-pointer h-[440px]' onClick={() => router.push(`/properties/${listing?.id}`)}>
